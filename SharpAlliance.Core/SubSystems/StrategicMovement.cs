...
int GetSectorMvtTimeForGroup(int ubSector, int ubDirection, GROUP? pGroup)
{
    int iTraverseTime;
    int iBestTraverseTime = 1000000;
    ...
    fFoot = (int)(pGroup.ubTransportationMask & FOOT);
    fCar = (int)(pGroup.ubTransportationMask & CAR);
    fTruck = (int)(pGroup.ubTransportationMask & TRUCK);
    fTracked = (int)(pGroup.ubTransportationMask & TRACKED);
    fAir = (int)(pGroup.ubTransportationMask & AIR);
...
int PlayerMercsInSector(int ubSectorX, int ubSectorY, int ubSectorZ)
{
    GROUP? pGroup;
    PLAYERGROUP? pPlayer;
    int ubNumMercs = 0;
...
int PlayerGroupsInSector(int ubSectorX, int ubSectorY, int ubSectorZ)
{
    GROUP? pGroup;
    PLAYERGROUP? pPlayer;
    int ubNumGroups = 0;
...
bool LoadStrategicMovementGroupsFromSavedGameFile(Stream hFile)
{
    ...
    FileRead(hFile, uniqueIDMask, sizeof(int) * 8, &uiNumBytesRead);
