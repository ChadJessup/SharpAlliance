...
public partial class Globals
{
	...
	public const int RUNDIVISOR = 1.8;
	...
	public static bool PTR_OURTEAM() => (Globals.pSoldier.bTeam == gbPlayerNum);
	...
	public const int SIGHT_LOOK = 0x1;
	//public const int SIGHT_SEND      0x2   // no longer needed using LOCAL OPPLISTs
	public const int SIGHT_RADIO = 0x4;
	public const int SIGHT_INTERRUPT = 0x8;
	public const int SIGHT_ALL = 0xF;
	...
	public static int SIDE() => (SIDE_RATIO * STRAIGHT_RANGE);
	public static int ANGLE() => (ANGLE_RATIO * STRAIGHT_RANGE);
	...
	public static int TOTAL_SOLDIERS() => (NUM_PLANNING_MERCS + MAX_NUM_SOLDIERS);
	...
	public const CIV_GROUP LAST_TEAM = CIV_GROUP.CIV_TEAM;
	...
	public static int SET_PALETTEREP_ID(string a, string b) => (strcpy(a, b));
