...
{
    public const int NO_SAMPLE = 0xffffff;
...
//    public SoundManager(IFileManager fileManager) => this.files = fileManager;
    ...
    //
    //*******************************************************************************
    public static bool SoundSetVolume(int uiSoundID, int uiVolume)
    {
        int uiSound, uiVolCap;
    ...
    //
    //*******************************************************************************
    public static int SoundGetIndexByID(int uiSoundID)
    {
        int uiCount;
